...
@section('content')
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">تحرير مستخدم
                </h1>
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        <div id="kt_app_content_container" class="app-container container-xxl">
            <form id="kt_user_edit_form" class="form d-flex flex-column flex-lg-row"
                        ...
                        <div class="card-body text-center pt-0">
                            ...
                            <div class="image-input image-input-empty image-input-outline image-input-placeholder mb-3"
                                ...
                                <div class="image-input-wrapper w-150px h-150px"
                                    @if ($user->photo) style="background-image: url('{{ asset('storage/' . $user->photo) }}')" @endif>
                                </div>
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            <select class="form-select mb-2" data-control="select2" data-hide-search="true"
                                ...
                                <option value=""></option>
                                <option value="1" {{ old('is_active', $user->is_active) == 1 ? 'selected' : '' }}>نشط
                                </option>
                                <option value="0" {{ old('is_active', $user->is_active) == 0 ? 'selected' : '' }}>غير
                                    نشط</option>
                            </select>
                        ...
                        <div class="card-body pt-0">
                            <select class="form-select mb-2" data-control="select2" data-hide-search="true"
                                data-placeholder="اختر حالة التحقق" id="kt_user_add_status_select" name="is_approved">
                                <option value=""></option>
                                <option value="1" {{ old('is_approved', $user->is_approved) == 1 ? 'selected' : '' }}>
                                    موثق</option>
                                <option value="0" {{ old('is_approved', $user->is_approved) == 0 ? 'selected' : '' }}>
                                    غير موثق</option>
                            </select>
                ...
                <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                @error('user_type_id')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <div class="text-muted fs-7">اختر نوع المستخدم.</div>
                            </div>
                            <div class="mb-10 fv-row">
                        ...
                        <div class="card-body pt-0">
                            <div class="mb-10 fv-row">
                                ...
                                <input type="text" name="commercial_register"
                                    ...
                                    value="{{ old('commercial_register', optional($user->businessInfo)->commercial_register) }}" />
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <input type="text" name="tax_number"
                                    ...
                                    value="{{ old('tax_number', optional($user->businessInfo)->tax_number) }}" />
                                @error('tax_number')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                    ...
                    <div class="d-flex justify-content-end">
                        <a href="{{ route('dashboard.users.index') }}" id="kt_user_edit_cancel"
                            class="btn btn-light me-5">إلغاء</a>
                        <button type="submit" id="kt_user_edit_submit" class="btn btn-primary">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            form.addEventListener('submit', function(e) {
                ...
                Swal.fire({
                    text: "هل أنت متأكد من تحديث هذا المستخدم؟",
                    icon: "warning",
