        ...
        <div class="card card-flush">
            ...
            <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                ...
                <div class="card-toolbar">
                    ...
                    <a href="{{ route('dashboard.users.create') }}" class="btn btn-primary">إضافة مستخدم</a>
                    <a href="{{ route('dashboard.users.trashed') }}" class="btn btn-secondary">عرض المستخدمين المحذوفين</a>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <a href="{{ route('dashboard.users.edit', $user->id) }}" class="symbol symbol-50px">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="#" class="menu-link px-3"
                                                ...
                                                data-action="{{ route('dashboard.users.destroy', $user->id) }}">حذف</a>
                                        </div>
